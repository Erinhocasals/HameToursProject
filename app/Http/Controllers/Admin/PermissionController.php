...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get('roles_id'))
            $permission->roles()->sync($request->get('roles_id'));

        return redirect('admin/permission')->with('success', 'Se ha adicionado el elemento exitosamente!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/permission')->with('success', 'Se ha actualizado el elemento!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/permission')->with('success', 'Se ha eliminado el elemento!');
    }
}
