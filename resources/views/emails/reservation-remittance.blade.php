                          ...
                          <table cellspacing="0" cellpadding="0">
                            <tr>
                              <td align="center" width="400" height="40" bgcolor="#00c8d9" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; bord-radius: 5px; color: #FFFFFF; display: block;">
                                <a href="{{ $data['template']['action_url'] }}" style="font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block">
                                  <span style="color: #FFFFFF">{{ $data['template']['action_title'] }} &nbsp;&nbsp;&nbsp;>
                                  </span>
                                </a>
                              </td>
                            </tr>
