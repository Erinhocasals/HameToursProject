...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Contactos</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    {{-- <a href="{{ url('/admin/contact/create') }}" class="btn btn-primary btn-sm" title="Adicionar">
                        <i class="fa fa-plus" aria-hidden="true"></i> Adicionar nuevo
                    </a> --}}
                </div>
                <div class="card-body">
                    {{-- <form method="GET" action="{{ url('/admin/contact') }}" accept-charset="UTF-8" class="float-right my-2 form-inline my-lg-0" role="search">
                    ...
                    <div class="table-responsive">
                        <table id="example3" class="display">
                            <thead>
                                <tr>
                                    <th>#</th><th>Nombre</th><th>Correo</th><th class="text-center">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                            @foreach($contact as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('/admin/contact/' . $item->id) }}" title="Detalles"><button class="shadow btn btn-info btn-xs sharp me-1"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                        {{-- <a href="{{ url('/admin/contact/' . $item->id . '/edit') }}" title="Editar"><button class="shadow btn btn-primary btn-xs sharp me-1"><i class="fa fa-pencil" aria-hidden="true"></i></button></a> --}}
