...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">{{ $package->title }}</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0)">Tiempos</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Editar tiempo</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Editar tiempo</h4>
                    <a href="{{ url('/admin/package/' . $time->package->id) }}" title="Back"><button class="btn btn-light btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar</button></a>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ url('/admin/time/' . $time->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        @include ('admin.package-time.form', ['formMode' => 'edit'])
