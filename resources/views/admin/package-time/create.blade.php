...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Nuevo tiempo</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Nuevo tiempo</h4>
                    <a href="{{ url('/admin/time') }}" title="Back"><button class="btn btn-light btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar</button></a>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/admin/time') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        @include ('admin.package-time.form', ['formMode' => 'create'])
