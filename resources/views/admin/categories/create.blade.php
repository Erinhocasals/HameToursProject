...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">@if ($type == 1) Regiones @elseif ($type == 2) Definiciones @else Agencias @endif</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Nueva Definición</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Nueva Definición</h4>
                    <a href="{{ url('/admin/categories?type=' . $type) }}" title="Back"><button class="btn btn-light btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar</button></a>
                </div>
                <div class="card-body">
