...
<link href="{{ asset('admin-template/vendor/lightgallery/css/lightgallery.min.css') }}" rel="stylesheet">
@endprepend

@prepend('scripts')
<script src="{{ asset('admin-template/vendor/lightgallery/js/lightgallery-all.min.js') }}"></script>
...
@section('content')
    ...
    <div class="row">
        @include('admin.showcases.show-content')
    </div>
@endsection
