        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/admin/filter-categories') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        {{-- {{ csrf_field() }} --}}
                        @csrf

                        @include ('admin.filter-categories.form', ['formMode' => 'create'])
                    </form>
