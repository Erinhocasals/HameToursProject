...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">entity-package {{ $entity-package->id }}</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>entity-package {{ $entity-package->id }}</h4>
                    <div class="flex">
                        ...
                        <a href="{{ url('/admin/entity-package/' . $entity-package->id . '/edit') }}" title="Editar"><button class="mr-1 shadow btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>

                        <form method="POST" action="{{ url('admin/entity-package' . '/' . $entity-package->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <th>ID</th><td>{{ $entity-package->id }}</td>
                                </tr>
                                <tr><th> Name </th><td> {{ $entity-package->name }} </td></tr><tr><th> Content </th><td> {{ $entity-package->content }} </td></tr>
                            </tbody>
                        </table>
                    </div>
