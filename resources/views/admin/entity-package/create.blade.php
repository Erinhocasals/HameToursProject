...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">New entity-package</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">New entity-package</h4>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/admin/entity-package') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        @include ('admin.entity-package.form', ['formMode' => 'create'])
