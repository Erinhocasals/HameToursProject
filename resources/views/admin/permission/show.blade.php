...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ $permission->name }}</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="flex">
                        <a href="{{ url('/admin/permission') }}" title="Regresar"><button class="mr-1 shadow btn btn-light btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar</button></a>
                        <a href="{{ url('/admin/permission/' . $permission->id . '/edit') }}" title="Editar"><button class="mr-1 shadow btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
                            ...
                            <tbody>
                                ...
                                <tr><th> Roles </th><td>
                                    @foreach ($permission->roles as $role)
                                        <a href="{{ route('admin.roles.show', ['role' => $role->id]) }}"> <span class="badge badge-sm light badge-primary">{{ $role->name }}</span> </a>
                                    @endforeach
                                </td></tr>
                            </tbody>
                        </table>
