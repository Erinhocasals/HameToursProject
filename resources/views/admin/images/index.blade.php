...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Imágenes</a></li>
        </ol>
    </div>
                        ...
                        <table id="example3" class="display">
                            ...
                            @foreach($images as $item)
                                <tr>
                                    ...
                                    <td><img class="h-24 shadow rounded-sm object-cover" src="{{ asset('storage/' . $item->url) }}" /></td>
                                    <td> <a href="#"> <span class="badge badge-sm light badge-primary">{{ $item->imageable->title }}</span> </a> </td>
                                    <td class="text-center">
                                        <a href="{{ url('/admin/images/' . $item->id) }}" title="Detalles"><button class="shadow btn btn-info btn-xs sharp me-1"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                        <a href="{{ url('/admin/images/' . $item->id . '/edit') }}" title="Editar"><button class="shadow btn btn-primary btn-xs sharp me-1"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
