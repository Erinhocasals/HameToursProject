...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Beneficiarios</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ $beneficiary->name }}</a></li>
        </ol>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="flex">
                        <a href="{{ url('/admin/beneficiary') }}" title="Regresar"><button class="mr-1 shadow btn btn-light btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar</button></a>
                        {{-- <a href="{{ url('/admin/beneficiary/' . $beneficiary->id . '/edit') }}" title="Editar"><button class="mr-1 shadow btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>

                        <form method="POST" action="{{ url('admin/beneficiary' . '/' . $beneficiary->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr><th> Usuario </th><td> <a href="{{ route('admin.users.show', ['user' => $beneficiary->user->id]) }}"> <span class="badge badge-sm light badge-primary">{{ $beneficiary->user->name }}</span> </a> </td></tr>
