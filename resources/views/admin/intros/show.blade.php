...
@section('content')
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Intros</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">@if ($intro->introable){{ $intro->introable->title }}@endif</a></li>
        </ol>
    </div>
    ...
    <div class="row">
        @include('admin.intros.show-content')
    </div>
@endsection
