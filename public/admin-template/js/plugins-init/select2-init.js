...
(function($) {
  ...
  $(".js-programmatic-btn-select-all").on('click', function () {
      $('.multi-select').select2('destroy').find('option').prop('selected', 'selected').end().select2();
  })

  $(".js-programmatic-btn-select-none").on('click', function () {
      $('.multi-select').select2('destroy').find('option').prop('selected', false).end().select2();
  })
